...
def test_every_case_has_a_narrative() -> None:
    """Jeder gelieferte Fall ist messbar.

    Ein Fall ohne Erzählung kann nicht gefahren werden. Er wäre kein
    Platzhalter, sondern eine Lücke, die im Bericht als Ergebnis erscheint.
    """
...
def test_the_other_cases_do_not_forbid_anything_everywhere() -> None:
    """Für die gelieferten Fälle bleibt die Liste leer.
    ...
    Die Prüfung selbst hängt an `DER_BETRIEB`, einem Fall, der eigens
    dafür in dieser Datei steht.
    """
