...
def _part_two(**overrides: object) -> dict[str, object]:
    ...
    data: dict[str, object] = {
        ...
        "wert": _value(),
        "systeme": [
            {"name": "Outlook", "umgang": "Meldungen werden übernommen."},
            {"name": "Telefon", "umgang": "Notizen werden erfasst."},
            {"name": "WhatsApp", "umgang": "Nachrichten laufen mit ein."},
            {"name": "Buchhaltung", "umgang": "Bleibt unverändert bestehen."},
        ],
        "architektur": [
            {"ebene": "Eingang", "beschreibung": "Nimmt Meldungen entgegen."},
            {"ebene": "Verstehen", "beschreibung": "Ordnet die Meldung ein."},
            {"ebene": "Arbeit", "beschreibung": "Führt den Vorgang."},
            {"ebene": "Übersicht", "beschreibung": "Zeigt den Stand."},
        ],
        "umsetzung": [
            "Sammelstelle einrichten",
            "Eingangswege umleiten",
            "Vorgangskarte anlegen",
            "Zuständigkeiten festlegen",
            "Eine Woche mitlaufen lassen",
            "Zehn Fälle nachprüfen",
        ],
    }
    data.update(overrides)
    return data
