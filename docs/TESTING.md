...
| **Die Messwerkzeuge** | `test_gold_lauf.py`, `test_messlauf.py`, `test_zehn_laeufe.py` | dass die Messskripte messen, was sie behaupten |
...
|---|---|---|
| `scripts/gold_lauf.py` | fährt die 13 Evaluationsfälle durch die Anwendung und vergleicht mit hinterlegten Erwartungen | 3 Aufrufe je Fall |
| `scripts/messlauf.py` | stellt Konfigurationen gegeneinander — Abruf an/aus, Prompt A/B | 2 je Lauf |
