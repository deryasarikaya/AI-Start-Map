...
- **Übernahmen kommen vor.** In einer Messung hat das Modell einen Satz aus
  einem abgerufenen Abschnitt wörtlich in den Kundentext übernommen. Der
  Goldlauf prüft deshalb jedes Ergebnis gegen die Prompts und das
  abgerufene Wissen — wörtliche Übernahmen daraus werden gemeldet.
