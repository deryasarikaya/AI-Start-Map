...
class Fallergebnis:
    ...
    #: nicht auf `jetzt`. Für den Massagesalon sind das die Themen, zu
    #: denen er nicht gefragt hat: wie er bezahlt, was bar läuft, wie er
    #: abrechnet. Ein gut gemeinter Hinweis dazu ist eine Belehrung und
    #: beschädigt den Rest der Auswertung.
